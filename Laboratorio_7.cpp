...
void archivos()
{
    ...
    ofstream archivo_salida("NOMBRE DEL ARCHIVO Y UBICACION");
    ...
    ifstream archivo_entrada("xxxxxxxxxxxxxx.txt");
...
void objetos()
{
    ...
    Persona persona1("Betty", 30, "Presidenta de finanzas");
    Persona persona2("Patricia", 29, "Secretaria");
...
void com()
{
    ...
    Estudiante estudiante("Jose", 15, "Estudiante", 79421, 9);
...
void ordenamiento()
{
    ...
    vector<string> nombres = {"Juan", "Pablo", "Carlos", "Ana", "Camilla"};
